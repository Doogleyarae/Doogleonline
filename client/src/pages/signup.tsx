    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-4xl flex flex-col lg:flex-row gap-8 items-center justify-center">
        ...
        <aside className="hidden lg:flex flex-col justify-center w-1/2 h-full bg-white/70 rounded-xl shadow-md p-8 mr-2">
          <h2 className="text-2xl font-bold text-primary mb-4">Welcome to Doogle Online!</h2>
          <p className="text-gray-700 mb-4">Join thousands of users exchanging currencies quickly, securely, and at the best rates. Enjoy 24/7 support and instant transactions.</p>
          <ul className="mb-6 list-disc list-inside text-gray-600">
            <li>✔️ Fast, secure currency exchange</li>
            <li>✔️ 11+ payment methods supported</li>
            <li>✔️ Real-time rates &amp; order tracking</li>
            <li>✔️ Trusted by users worldwide</li>
          </ul>
          <div className="mb-6">
            <h3 className="font-semibold text-gray-800 mb-2">Tips for a smooth sign up:</h3>
            <ul className="list-disc list-inside text-gray-600 text-sm">
              <li>Use your real name for verification</li>
              <li>Choose a strong password (8+ characters)</li>
              <li>Double-check your email and phone number</li>
              <li>Read and accept the Terms of Service</li>
            </ul>
          </div>
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded mb-4">
            <p className="italic text-blue-900 text-sm">“Doogle Online made exchanging currencies so easy and fast. Highly recommended!”<br/><span className="font-semibold">– Amina, Mogadishu</span></p>
          </div>
        ...
        <aside className="block lg:hidden w-full mt-8 bg-white/70 rounded-xl shadow-md p-6">
          ...
          <ul className="mb-4 list-disc list-inside text-gray-600 text-sm">
            ...
            <li>11+ payment methods</li>
            <li>Real-time rates &amp; order tracking</li>
          </ul>
          <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded mb-2">
            <p className="italic text-blue-900 text-xs">“Super easy and reliable!” – Amina</p>
          </div>
