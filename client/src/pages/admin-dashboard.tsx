          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {paymentMethods.filter(method => method.value !== 'sahal' && method.value !== 'zaad' && method.value !== 'evc' && method.value !== 'edahab' && method.value !== 'premier' && method.value !== 'moneygo' && method.value !== 'trx' && method.value !== 'trc20' && method.value !== 'peb20').map((fromMethod) => (
