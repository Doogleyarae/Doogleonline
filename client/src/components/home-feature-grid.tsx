    ...
    <section className="w-full py-16" aria-labelledby="features-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 id="features-heading" className="text-3xl font-bold text-gray-900 mb-4">Why Choose DoogleOnline?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8" role="list" aria-label="Key features">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="text-center p-6 hover:shadow-lg transition-shadow duration-200" role="listitem">
                <CardContent className="pt-6">
                  <div className={`${feature.bgColor} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`} aria-hidden="true">
