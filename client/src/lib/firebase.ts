...
const firebaseConfig = {
  apiKey: "AIzaSyA7jy7FNlH--Rkpd627WRvq5bikM1r7xVc",
  ...
  appId: import.meta.env.VITE_FIREBASE_APP_ID || "1:478312672914:web:default",
...
// Google Authentication - using redirect method for Replit compatibility
export const loginWithGoogle = async () => {
  try {
    ...
    // Use redirect method for better Replit domain compatibility
