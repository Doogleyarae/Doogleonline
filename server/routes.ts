...
async function getCurrencyLimits(currency: string): Promise<{ min: number; max: number }> {
  ...
  // Default fallback limits - increased maximum amounts
  const defaults: Record<string, { min: number; max: number }> = {
    zaad: { min: 5, max: 100000 },
    sahal: { min: 5, max: 100000 },
    evc: { min: 5, max: 100000 },
    edahab: { min: 5, max: 100000 },
    premier: { min: 5, max: 100000 },
    moneygo: { min: 5, max: 100000 },
    trx: { min: 1, max: 50000 },
    trc20: { min: 1, max: 50000 },
    peb20: { min: 5, max: 100000 },
    usdc: { min: 5, max: 100000 }
  };
  
  return defaults[currency.toLowerCase()] || { min: 5, max: 100000 };
}
