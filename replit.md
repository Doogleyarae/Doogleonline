...
- June 16, 2025. Reduced payment methods to essential 5 options per user request - platform now supports only Zaad, Sahal, EVC Plus, eDahab, and Premier Bank. Removed MoneyGo, TRX, TRC20, PEB20, and USDC from all pages and admin dashboard. Updated default exchange form values to use Zaad → Premier Bank instead of TRC20 → MoneyGo
